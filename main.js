this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var zz = new Date(2021, 5, 19, 0, 0, 0, 0);
  zz.setDate(zz.getDate() + (JSON.parse(window.localStorage.getItem('puzzle')) || Math.round(Math.abs(new Date().setHours(0, 0, 0, 0) - zz) / 864e5)));
  ...
  Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n   position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 36px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div>\n        </div>\n        <div class="control">\n          <a href="mailto:suhasasj@gmail.com?subject=Feedback" title="suhasasj@gmail.com">Email</a>\n          |\n          <a href="https://github.com/suhasa010/wordle" target="blank" title="@suhasa010">Github</a>\n        </div>\n      </div>\n    </section>\n   <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Based on César Nogueira\'s version</div>\n        </div>\n        <div class="control">\n          <a href="mailto:wordle@cesarnogueira.com?subject=Feedback" title="wordle@cesarnogueira.com">Email</a>\n          |\n          <a href="https://github.com/cesarnogueira/wordle" target="blank" title="@cesarnogueira">Github</a>\n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="copyright">Copyright 2021-2022. All Rights Reserved.</div>\n    <div>\n      <div id="puzzle-number"></div>\n      <div id="hash"></div>\n    </div>\n  </div>\n';
  var _a = function(e) {
      r(t, e);
      var a = h(t);
  ...
  customElements.define("game-toast", Aa), window.dataLayer = window.dataLayer || [], Ca("js", zz);
          ...
          return o(t, [{
              ...
              value: function() {
                  if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                      ...
                      if (i || l) Va({
                          isWin: l,
                          isStreak: !!this.lastCompletedTs && 1 === Na(new Date(this.lastCompletedTs), zz),
              ...
              value: function() {
                  ...
                  })), this.shadowRoot.getElementById("today-button").addEventListener("click", (function() {
                      window.localStorage.removeItem('gameState');
                      window.localStorage.setItem('puzzle', JSON.parse(Math.round(Math.abs(new Date().setHours(0, 0, 0, 0) - Ha) / 864e5)));
                      window.location.reload();
                  })), this.shadowRoot.getElementById("random-button").addEventListener("click", (function() {
                      window.localStorage.removeItem('gameState');
                      window.localStorage.setItem('puzzle', JSON.parse(Math.floor(Math.random() * La.length)));
                      window.location.reload();
                  })), this.shadowRoot.getElementById("previous-button").addEventListener("click", (function() {
                      var i = JSON.parse(window.localStorage.getItem('puzzle')) || Math.abs(new Date().setHours(0, 0, 0, 0) - Ha) / 864e5;
                      window.localStorage.removeItem('gameState');
                      window.localStorage.setItem('puzzle', JSON.parse(Math.max(i - 1, 0)));
                      window.location.reload();
                  })), this.shadowRoot.getElementById("next-button").addEventListener("click", (function() {
                      var i = JSON.parse(window.localStorage.getItem('puzzle')) || Math.abs(new Date().setHours(0, 0, 0, 0) - Ha) / 864e5;
                      window.localStorage.removeItem('gameState');
                      window.localStorage.setItem('puzzle', JSON.parse(Math.min(i + 1, La.length - 1)));
                      window.location.reload();
      ...
      Os = function(e) {
          ...
          return o(t, [{
              ...
              value: function() {
                  ...
                  if (["gamesPlayed", "winPercentage"].forEach((function(s) {
                          var t = Ms[s],
                              o = e.stats[s],
                      ...
                      p.appendChild(m), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
                          ...
                          As(function(e) {
                              ...
                              })), stats = "".concat(l, "%0A%0A").concat(d.trimEnd()); {
                                  text: "".concat(l, "\n\n").concat(d.trimEnd())
                              }
                          }({
                              ...
                              window.open(`https://t.me/share/url?text=%0A${stats}&url=https://t.me/rewordlebot`)
                            //   navigator
                            //     .share({
